...
var specFiles = Object.keys(window.__karma__.files).filter(isToyotaAngularSpecFile);
...
/** Runs the Toyota Angular specs in Karma. */
function runToyotaSpecs() {
...
/** Whether the specified file is part of Toyota Angular. */
function isToyotaAngularSpecFile(path) {
 ...
 * each unit test.
 *
 * Without this patch, the combination of two behaviors is problematic for Toyota Angular:
