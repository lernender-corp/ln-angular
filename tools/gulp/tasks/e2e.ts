...
import {buildConfig, sequenceTask, triggerLivereload, watchFiles} from 'lernender-angular-build-tools';
...
task('e2e:watch', sequenceTask(
  [':test:protractor:setup', 'serve:e2eapp'],
  [':test:protractor', 'angular:watch', ':e2e:watch'],
));
 ...
 */
task('serve:e2eapp:watch', ['serve:e2eapp', 'angular:watch', ':watch:e2eapp']);
