 ...
 * to build the different packages inside of Angular.
 */
...
/**
 * Required Angular version for all Toyota Angular packages. This version will be used
...
module.exports = {
  ...
  includePath: join(__dirname, 'src/asset/scss'),
